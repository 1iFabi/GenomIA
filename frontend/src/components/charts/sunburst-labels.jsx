...
export const SunburstLabels = memo(function SunburstLabels2({
  fontSize = 11,
  ...
  const enterDuration = typeof enterTransition?.duration === "number" ? enterTransition.duration : DEFAULT_CHART_ENTER_TRANSITION.duration;
