...
export const SunburstHint = memo(function SunburstHint2({
  className,
  children
}) {
  ...
  const hintText = (() => {
    ...
    if (focus.depth === 0) {
      return "Click a segment to zoom in \xB7 hover to inspect";
    }
  ...
  return <div
    aria-live="polite"
    className={className ?? "mt-3 min-h-5 text-center text-muted-foreground text-sm"}
    style={{ minHeight: 20 }}
  >
      {content}
    </div>;
